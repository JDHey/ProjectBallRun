 ...
 */
public class LogoItem2 extends Actor {
    public static final int WIDTH = Assets.logoMain.getRegionWidth();
    public static final int HEIGHT = Assets.logoMain.getRegionHeight();

    public Runnable runnableTurnOnShadow = new Runnable() {
        @Override public void run() { isShadowOn = true; System.out.print("Shadow is on"); }
    };
    ...
    public LogoItem2(float x, float y) {
        setPosition(x, y);
